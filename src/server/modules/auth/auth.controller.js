...
const { sendExpiryWarning, sendRegistrationEmail, sendPasswordResetEmail, isEmailConfigured } = require('./auth.service');
...
const forgotPassword = async (req, res) => {
  try {
    ...
    if (!isEmailConfigured()) return res.status(503).json({ error: 'Servicio de email no configurado' });
