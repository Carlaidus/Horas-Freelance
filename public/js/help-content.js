  ...
  // ── FACTURAS ───────────────────────────────────────────────
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: '**Fecha prevista de cobro:** la app la calcula con los d\u00edas de pago de la empresa, por ejemplo fecha de factura + 60 d\u00edas. Puedes cambiarla en una factura concreta.\n\n**Confirming:** indica que esa factura puede cobrarse mediante confirming. Puedes dejarlo marcado por defecto en la ficha de cada empresa.\n\n**Cobro adelantado por el banco:** \u00fasalo solo si aceptas el anticipo. En ese caso anota la fecha del cobro adelantado y el coste del adelanto. La fecha de pago final queda abajo, como fecha en que la factura se da por pagada.'
      },
      {
